...
export default async function handler(req, res) {
  console.log("API Key exists:", !!process.env.SENDINBLUE_API_KEY)
  console.log("API Key length:", process.env.SENDINBLUE_API_KEY?.length || 0)
    ...
    htmlContent: `<div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; box-shadow: 0 10px 25px -5px rgba(0, 0, 0, 0.1);">
      ...
      <div style="padding: 32px;">
          ...
          <div style="border: 1px solid #e5e7eb; border-radius: 8px; padding: 16px; margin-bottom: 32px; font-family: Arial, sans-serif;">
              ...
              <p style="margin: 8px 0; color: #111827;"><strong>Specialty:</strong> ${specialty}</p>
              <p style="margin: 8px 0; color: #111827;"><strong>Doctor:</strong> ${doctor}</p>
              <p style="margin: 8px 0; color: #111827;"><strong>Date:</strong> ${formattedDate}</p>
              <p style="margin: 8px 0; color: #111827;"><strong>Time:</strong> ${time}</p>
          </div>
          ...
          <div style="text-align: center; margin-bottom: 32px;">
              <div>
                  <a href="https://hsv-hospital.vercel.app/tracking" style="display: inline-block; background-color: transparent; color: #2563eb; text-decoration: none; font-weight: 500; padding: 12px 24px; border: 2px solid #2563eb; border-radius: 20px; margin: 0 8px; transition: all 0.3s ease;">Track Appointments</a>
                  <a href="https://hsv-hospital.vercel.app/booking" style="display: inline-block; background-color: transparent; color: #059669; text-decoration: none; font-weight: 500; padding: 12px 24px; border: 2px solid #059669; border-radius: 20px; margin: 0 8px; transition: all 0.3s ease;">Book New Appointment</a>
              </div>
          </div>
